 ...
 * @author timon
 */
public class BigEndianAscendingWordSerializerTest {
    /**
    ...
    public void constructorErrorTest() {
        ...
        try {
            new BigEndianAscendingWordSerializer(0/*wordLength, below minimum of 4*/, 1/*wordCount, arbitrary*/, 0/*bytePadding, arbitrary*/);
    ...
    /**
     * Smoke test for typical parameters used in {@link LongSetSlab}.
     */
    @Test
